  ...
  return (
    <View style={{ backgroundColor: 'white', alignItems: 'center' ,minHeight:"100%"}}>
      ...
      onPress={() => {
                ...
                }} style={{height:54,width:335,backgroundColor:"#4CAD73",borderRadius:10,alignItem:'center',justifyContent:'center'}}>
        <Text style={{textAlign:'center',fontSize:18,color:"#FFF"}}>Back</Text>
      </TouchableOpacity>
